...
class HomeParentPage extends StatefulWidget {
  const HomeParentPage({Key? key}) : super(key: key);

  @override
  HomeParentPageState createState() => HomeParentPageState();
}

class HomeParentPageState extends State<HomeParentPage> {
  ...
  Widget build(BuildContext context) {
    final chart = PieChart(
      ...
      chartRadius: math.max(MediaQuery.of(context).size.width / 3.2, 800),
      colorList: colorList,
