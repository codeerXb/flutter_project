                            ...
                            Container(
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (value) {
                                    debugPrint("输入的手机号或者邮箱是:$value");
                                    bool isphone = StringUtil.isPhoneNumber(value!);
                                    bool isemail = StringUtil.isEmail(value);
                                    debugPrint("输入的手机号或者邮箱是:$isphone---$isemail");
                                    
                                    if ((!StringUtil.isPhoneNumber(value) && !StringUtil.isEmail(value)) ||
                                        value.isEmpty) {
