...
class Visitor4 extends StatefulWidget {
  const Visitor4({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Visitor4State();
}
...
// 云端获取数据
  Future getCloudData() async {
    ...
    dataModel = model;
    debugPrint('5G Guest1获取的数据:$jsonObj');
    try {
